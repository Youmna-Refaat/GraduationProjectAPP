...
import 'package:graduation_application/screens/child/alerts_supervisor.dart';
...
class SupervisorBottomAppBar extends StatelessWidget
    implements PreferredSizeWidget {
  final double appBarHeight = 50.0;
  const SupervisorBottomAppBar({
    super.key,
  });
  @override
          ...
          children: [
            BottomAppBarItem(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  _createRoute(const SupervisorAlerts()),
                );
              },
            ),
            BottomAppBarItem(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  _createRoute(const SupervisorHomePage()),
                );
              },
            ),
            BottomAppBarItem(
